...
export default function Home() {
  return (
    <main style={{height: '200vh'}}
      ...
      sm: p-10 lg:p-24'
    >
      <h1 className='text-6xl font-extrabold mt-16 text-center bg-gradient-to-r from-fuchsia-600 to-violet-500 text-transparent bg-clip-text p-2'>Catchy SaaS Headline</h1>
